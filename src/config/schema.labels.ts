...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.securityFirewall": "Security Firewall",
  "tools.securityFirewall.enabled": "Enable Security Firewall",
  "tools.securityFirewall.profile": "Security Firewall Profile",
  "tools.securityFirewall.ownerBypass": "Security Firewall Owner Bypass",
  "tools.securityFirewall.promptGuard": "Security Firewall Prompt Guard",
  "tools.securityFirewall.audit": "Security Firewall Audit",
  "tools.securityFirewall.audit.enabled": "Security Firewall Audit Logging",
  "tools.securityFirewall.audit.path": "Security Firewall Audit Log Path",
  "tools.securityFirewall.rules": "Security Firewall Rules",
  ...
  "skills.policy.allowedCategories": "Allowed Skill Categories",
  "skills.policy.rejectUncategorized": "Reject Uncategorized Skills",
  "skills.entries.*.categories": "Skill Category Override",
  ...
  "channels.imessage": "iMessage (Legacy)",
  "channels.bluebubbles": "BlueBubbles (Legacy)",
  ...
  "channels.imessage.dmPolicy": "iMessage DM Policy (Legacy)",
  "channels.imessage.configWrites": "iMessage Config Writes (Legacy)",
  "channels.bluebubbles.dmPolicy": "BlueBubbles DM Policy (Legacy)",
  ...
  "channels.imessage.cliPath": "iMessage CLI Path (Legacy)",
  "agents.list[].skills": "Agent Skill Filter",
