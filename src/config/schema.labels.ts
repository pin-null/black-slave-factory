...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.permissionTier": "Tool Permission Tier",
  "tools.profile": "Tool Profile",
  "tools.alsoAllow": "Tool Allowlist Additions",
  "agents.list[].tools.permissionTier": "Agent Tool Permission Tier",
  ...
  "hooks.permissionTier": "Hooks Permission Tier",
  ...
  "hooks.mappings[].permissionTier": "Hook Mapping Permission Tier",
