...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/imessage/runtime-api.ts": [
    'export { DEFAULT_ACCOUNT_ID, buildChannelConfigSchema, formatTrimmedAllowFromEntries, getChatChannelMeta, looksLikeIMessageTargetId, normalizeIMessageMessagingTarget, resolveIMessageConfigAllowFrom, resolveIMessageConfigDefaultTo, IMessageConfigSchema, type ChannelPlugin, type IMessageAccountConfig } from "openclaw/plugin-sdk/imessage-core";',
    'export { PAIRING_APPROVED_MESSAGE, collectStatusIssuesFromLastError, resolveChannelMediaMaxBytes } from "openclaw/plugin-sdk/channel-runtime";',
