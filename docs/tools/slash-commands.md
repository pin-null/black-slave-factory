...
- `commands.text` (default `true`) enables parsing `/...` in chat messages.
  - On surfaces without native commands (WhatsApp/WebChat/Signal/MS Teams and similar legacy-compatible surfaces), text commands still work even if you set this to `false`.
